...
all_grids_and_sectors = [
    (grid, sector) for grid in all_grids for sector in get_sector_classes()]

all_grids_and_empty_sectors = [
    (grid, sector) for grid in all_grids for sector in get_emtpy_sector_classes()]
