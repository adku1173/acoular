...
class SetupSourceCase:
    ...
    def __init__(self):
        ...
        self.source = MaskedTimeSamples(
            ...
            invalid_channels=[1, 7], start=0, stop=16000, calib=self.calib)
        self.mics = MicGeom(from_file=test_config.moduledir / 'acoular' / 'xml' / 'array_56.xml', invalid_channels=[1, 7])
